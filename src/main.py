...
@click.option(
    "--load_config", type=click.Path(exists=True), default=None, help="Config JSON-file path (default: None)."
)
...
@click.option(
    "--ratio_known_normal", type=float, default=0.0, help="Ratio of known (labeled) normal training examples."
)
@click.option(
    "--ratio_known_outlier", type=float, default=0.0, help="Ratio of known (labeled) anomalous training examples."
)
@click.option(
    "--ratio_pollution",
    type=float,
...
@click.option("--seed", type=int, default=451, help="Set seed. If -1, use randomization.")
@click.option(
    "--optimizer_name",
...
@click.option(
    "--lr", type=float, default=0.001, help="Initial learning rate for Deep SAD network training. Default=0.001"
)
...
@click.option(
    "--weight_decay", type=float, default=1e-6, help="Weight decay (L2 penalty) hyperparameter for Deep SAD objective."
)
...
@click.option(
    "--ae_lr", type=float, default=0.001, help="Initial learning rate for autoencoder pretraining. Default=0.001"
)
