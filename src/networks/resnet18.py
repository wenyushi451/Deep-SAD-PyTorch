...
class ResNet(BaseNet):
    def __init__(self, ResBlock, rep_dim=128):
...
class CIFAR10_LeNet_Autoencoder(BaseNet):
    def __init__(self, rep_dim=128):
        ...
        self.rep_dim = rep_dim
        self.encoder = ResNet(rep_dim=rep_dim)
        self.decoder = ResNet_Decoder(rep_dim=rep_dim)
